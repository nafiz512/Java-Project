...
public class Search_Flight_Details extends javax.swing.JFrame {
    ...
    public static  int total_seat=0,bseat=0;
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight_Id", "Flight_Name", "Source", "Destination", "Seat", "Date", "Arrival_Time", "Departure_Time", "Flight_Price"
            }
        ));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                .addGap(18, 18, 18)
                                                .addComponent(tprice, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                .addGap(18, 18, 18)
                                                .addComponent(fprice, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGap(86, 86, 86)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
    ...
    Date selectedDate = (Date) Date.getDate(); 
    String date;
    if (selectedDate != null) {
        date = da.format(selectedDate);
    } else {
        date = "0000-00-00"; 
    }
       String sql="select * from flight where (Source=? and Destination=?) or (Date=?) ";
       try{
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        try {
            ...
            java.util.Date date=new SimpleDateFormat("yyyy-MM-dd").parse(Df.getValueAt(selectIndex, 5).toString());
            Date1.setDate(date);
            atime.setText(Df.getValueAt(selectIndex,6).toString());
            dtime.setText(Df.getValueAt(selectIndex,7).toString());
            fprice.setText(Df.getValueAt(selectIndex,8).toString());
            
          total_seat = Integer.parseInt(Df.getValueAt(selectIndex, 4).toString());
         seat_price = Integer.parseInt(Df.getValueAt(selectIndex, 8).toString());
    ...
    private void bticketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bticketActionPerformed
        // TODO add your handling code here:
        bseat = Integer.parseInt(seats.getValue().toString());
       
        if(total_seat-bseat>=0 && bseat>0)
        {
        //setVisible(false);
        ...
        try {
            String sql="insert into book_ticket(Ticket_No,Flight_Id,Flight_Name,Source,Destination,Date,Arrival_Time,Departure_Time,Total_Price,Seats,C_Name,pss)values(?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private void homeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_homeActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        if(airlineUser.check==1)
       {
           Home ob=new Home();
            ob.setVisible(true);
       }
       else if(airlineUser.check==2)
       {
