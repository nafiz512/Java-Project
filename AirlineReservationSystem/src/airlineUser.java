 ...
 * @author user
 */
public class airlineUser extends javax.swing.JFrame {

    /**
     * Creates new form airlineUser
     */
    public static int check = 0;
//    public void setUser(int check)
//    {
//        this.check=check;
//    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/n2.jpeg"))); // NOI18N
        ...
        jLabel1.setText("Bangladesh");

        admin.setBackground(new java.awt.Color(153, 153, 0));
        ...
        user.setForeground(new java.awt.Color(0, 102, 51));
        user.setText("User");
        user.setBorder(null);
        ...
        jLabel5.setText("Fly the Bengali way—safe, smooth, and stylish!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(airlineUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new airlineUser().setVisible(true);
            }
        });
    }
